...
function create(){
	if(!indiaccomodation){
		return;
		window.alert("Please Again Deslect and Select the Acoomodation");
	}
...
function contiCreate(){
  ...
  window.alert("Error : "+ errorMessage);
		...
		ref.push(detail);
		document.getElementById("goback").innerHTML = "Your Registration is Complete !! Please Verify Your E-mail before Event Registration !!";
